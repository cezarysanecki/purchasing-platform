...
class VerificationRepositoryInMemory implements VerificationRepository {
  ...
  private final Map<RegistrationFormId, Json> database = new ConcurrentHashMap<>();

  @Override
  public void saveNew(final RegistrationFormId registrationFormId, final Json registrationForm) {
